...
HUB_EMO_TEXT_MODEL_ID = env('HUB_EMO_TEXT_MODEL_ID', default=None)
HUB_EMO_TEXT_PRIVATE_REPO = env('HUB_EMO_TEXT_PRIVATE_REPO', default=False)
...
HUB_BIMODEL_MODEL_ID = env("HUB_BIMODEL_MODEL_ID", default=None)
HUB_BIMODEL_PRIVATE_REPO = env("HUB_BIMODEL_PRIVATE_REPO", default=None)
...
DPR_ENCODER_PATH = env('DPR_ENCODER_PATH', default=None)

DYNAEVAL_MODEL_PATH = env('DYNAEVAL_MODEL_PATH', default=None)
DYNAEVAL_ROBERTA_DIR = env('DYNAEVAL_ROBERTA_DIR', default=None)